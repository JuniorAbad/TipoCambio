...
// Ruta para obtener el historial de solicitudes de cambio
app.get('/history', async (req, res) => {
  ...
  try {
    ...
    // Buscar solicitudes en el rango de fechas
    ...
    res.status(500).send('Error en la obtención del historial de solicitudes.');
  }
});
